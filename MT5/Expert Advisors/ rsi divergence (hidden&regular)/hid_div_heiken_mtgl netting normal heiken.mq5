//+------------------------------------------------------------------+
//|                    hid_div_heiken_mtgl netting normal heiken.mq5 |
//|                                                          Samaara |
...
//this ea is a copy of hid_div_heiken_mtgl netting. the only thing which has changed is the heikan ashi entry.
//the heiken ashi entry is based on colour change only and not on "strong bullish" or "strong bearish"
...
void OnTick()
{
   ...
   hkn_ashi_handle = iCustom(_Symbol, lower_timeframe, "\\Indicators\\Heiken_Ashi.ex5");
